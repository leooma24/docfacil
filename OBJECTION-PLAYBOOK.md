# Playbook de Manejo de Objeciones — DocFacil
...
## Framework General: A-Q-R-C

Toda objecion se maneja con 4 pasos:
...
| "Con todo respeto..." | Lo que sigue siempre es una falta de respeto | Mejor callate |
| "Mire, doctor..." (tono condescendiente) | Se sienten lectured | Habla como igual, no como profesor |

---

## Senales de Compra

El doctor ya esta convencido (aunque no lo diga) cuando:

- **Hace preguntas de implementacion**: "¿Y como le hago para meter a mi secretaria?", "¿Funciona en mi tablet?"
- **Pide especificos de su especialidad**: "¿Tiene odontograma?", "¿Puedo poner notas SOAP?"
- **Menciona a su equipo**: "Tendria que ensenarle a Lupita", "Mi socio deberia ver esto"
- **Pregunta por precio con detalle**: "¿El Pro incluye recetas?", "¿Puedo empezar con Basico y luego subir?"
- **Se proyecta al futuro**: "Cuando abra el otro consultorio...", "Si me funciona voy a..."
- **Saca el celular o la tablet** para ver algo de lo que le muestras
- **Dice "dejame ver"** y toma tu dispositivo
- **Pregunta por la prueba gratis** o por como registrarse

Cuando detectes una o mas senales: deja de vender y facilita la accion.
...
#### 1. "Esta caro" / "No tengo presupuesto"

**Lo que dice:** "No, esta caro para lo que es" / "Ahorita no tengo para eso"

**Lo que realmente piensa:** No ve el valor todavia. No entiende como le va a regresar ese dinero. O simplemente es su primera reaccion automatica a cualquier precio.
...
#### 2. "¿Por que pagar si puedo usar Excel?"

**Lo que dice:** "Pues yo llevo todo en mi Excel y jala bien" / "Mi secre tiene sus hojitas y no batallamos"

**Lo que realmente piensa:** Miedo al cambio. Excel "funciona" aunque sea ineficiente. No quiere aprender algo nuevo ni que su equipo batalle.

**Respuesta:**

"Excel es buena herramienta, yo tambien la uso para muchas cosas. Pero dejeme preguntarle: cuando un paciente le llama para saber a que hora es su cita, ¿cuanto se tarda su secretaria en encontrar el dato? ¿Y si necesita ver el historial clinico de alguien de hace 6 meses? En Excel eso son minutos buscando. Aqui son 2 segundos. Y aparte Excel no le manda recordatorios por WhatsApp, no genera recetas PDF con su logo, y no le dice cuantos pacientes atendio este mes vs el pasado. No es que Excel este mal — es que usted ya crecio mas que Excel."
...
#### 3. "Hay opciones gratis"

**Lo que dice:** "Vi que hay apps gratis en internet" / "¿No tiene uno gratis?"

**Lo que realmente piensa:** Quiere ver si hay alternativa sin riesgo. Tambien puede que no confie en pagar software aun.
...
#### 4. "No se si lo voy a usar"

**Lo que dice:** "¿Que tal si lo pago y no lo uso?" / "He comprado cosas asi y quedan arrumbadas"

**Lo que realmente piensa:** Miedo a desperdiciar dinero. Probablemente ya le ha pasado con otro software o gadget.
...
#### 5. "No soy tecnologico" / "No le entiendo a esas cosas"

**Lo que dice:** "Ay no, yo de computadoras no se nada" / "Eso de las apps a mi no se me da"

**Lo que realmente piensa:** Miedo a sentirse tonto. Verguenza de no saber. No quiere quedar mal frente a su equipo.
...
#### 6. "Mi secretaria maneja todo en papel y funciona"

**Lo que dice:** "Lupita lleva la agenda en su libreta y no falla" / "Asi hemos trabajado 15 anos"

**Lo que realmente piensa:** Si no esta roto, para que arreglarlo. Tambien puede haber miedo a que la secretaria no se adapte y se vaya.
...
#### 7. "Ya tengo un sistema" (Doctoralia, Dentalink, otro)

**Lo que dice:** "Ya uso Doctoralia" / "Tengo Dentalink" / "Mi contador me puso un programa"

**Lo que realmente piensa:** Cambiar de sistema da flojera. Migrar datos es estresante. No quiere duplicar esfuerzos.
...
**Dato comparativo (de la landing):**

| | DocFacil | Doctoralia | Dentalink | Dentrix |
|---|---|---|---|---|
| 100% web | Si | No | No | Si |
...
#### 8. "¿Y si se cae el internet?"

**Lo que dice:** "Aqui el internet se va cada rato" / "¿Y si no hay red que hago?"

**Lo que realmente piensa:** Miedo a quedarse sin herramienta de trabajo en medio de una consulta. Depender de algo externo.

**Respuesta:**

"Buena pregunta. Mire, DocFacil es web, entonces si necesita internet. Pero pienselo asi: usted ya depende del internet para WhatsApp, para el banco, para todo. Y cuando se va el internet, ¿que hace? Lo mismo que haria con DocFacil: espera 5 minutos a que regrese. Ademas, hoy en dia con los datos del celular tiene plan B. Y algo importante: sus datos nunca se pierden. Si se va la luz a media consulta, cuando regresa todo sigue ahi tal cual lo dejo. No es como Excel que si no guardo se pierde."

**Pregunta de seguimiento:** "¿Que tan seguido se le va el internet? ¿Tiene datos en su celular como respaldo?"
...
#### 9. "¿Mis datos estan seguros?"

**Lo que dice:** "Es que la informacion de mis pacientes es delicada" / "¿Donde se guardan los datos?"

**Lo que realmente piensa:** Miedo real y valido a una filtracion. Responsabilidad legal. Tambien desconfianza en algo "en la nube."

**Respuesta:**

"Me da gusto que pregunte eso, doctor, porque significa que se toma en serio la privacidad de sus pacientes. Mire, DocFacil usa encriptacion SSL — la misma que usan los bancos. Los datos se respaldan automaticamente todos los dias. Cada clinica esta completamente separada: usted no puede ver datos de otro consultorio y nadie puede ver los suyos. Ademas, todo tiene historial — si alguien cambia algo, queda registro de quien lo hizo y cuando. Es mas seguro que un expediente en papel en un archivero sin llave, ¿no cree?"

**Pregunta de seguimiento:** "¿Actualmente como resguarda los expedientes de sus pacientes? ¿Los tiene bajo llave?"

---

#### 10. "¿Quien esta detras de esto?" / "No los conozco"

**Lo que dice:** "¿Y ustedes quienes son?" / "Es que no se de que empresa es"

**Lo que realmente piensa:** No quiere ser estafado. Necesita credibilidad. Es sano y razonable.
...
**Lo que dice:** "¿Que pasa si tronan y me quedo sin datos?" / "He visto empresas que nomás duran un ano"

**Lo que realmente piensa:** Miedo legitimo. Ha visto negocios cerrar. No quiere invertir tiempo en algo que se va a ir.
...
#### 12. "Necesito pensarlo" / "Dejame consultarlo"

**Lo que dice:** "Dejeme pensarlo y le marco" / "Deja lo platico con mi esposa/socio"

**Lo que realmente piensa:** Puede ser que genuinamente necesite tiempo. O puede ser un "no" educado. Hay que distinguir.

**Respuesta:**

"Claro, tomese su tiempo. Nada mas para que tenga toda la informacion: ¿hay algo especifico que le genere duda? Porque a veces uno dice 'lo pienso' pero en realidad hay un detalle particular que si lo resolvemos ahorita, ya no necesita pensarlo. Sin presion, eh, nada mas quiero asegurarme de no dejarle una duda sin resolver."

**Pregunta de seguimiento (si dice que va a consultar con alguien):** "Perfecto. ¿Le gustaria que le mande un resumen por WhatsApp para que se lo ensene a [su socio/esposa]? Asi tiene la info a la mano."

**Tactica:** Ofrece enviar algo tangible (PDF, link al demo, video de 2 min). Esto mantiene la conversacion viva y le da pretexto para dar seguimiento en 2-3 dias.
...
#### 13. "Ahorita no es buen momento"

**Lo que dice:** "Dejelo para despues del verano" / "Ahorita estamos en temporada baja"

**Lo que realmente piensa:** No es prioridad. Puede que tenga otros gastos mas urgentes. O es una forma de decir no.

**Respuesta:**

"Lo entiendo. Pero fijese que justamente cuando esta mas tranquilo es el mejor momento para implementar algo nuevo — porque tiene tiempo de configurarlo y aprenderlo sin prisa. Si espera a que este hasta el tope de pacientes, ahi si no va a tener tiempo de nada. Ademas, el plan gratuito no le cuesta nada: puede ir metiendose de a poquito y cuando llegue la temporada fuerte ya lo tiene rodando."

**Pregunta de seguimiento:** "¿Cuando es su temporada fuerte? Asi calculamos que para esa fecha ya lo tenga dominado."

---

#### 14. "Cuando tenga mas pacientes"

**Lo que dice:** "Estoy empezando, todavia no tengo tantos pacientes" / "Cuando crezca lo considero"

**Lo que realmente piensa:** Siente que es un gasto para algo que "todavia no necesita." No ve que el software le ayuda a CRECER, no solo a administrar.
...
#### 15. "Estoy por cambiar de consultorio"

**Lo que dice:** "Me voy a cambiar de local el mes que entra" / "Estoy remodelando"

**Lo que realmente piensa:** Tiene la cabeza en otro lado. No quiere sumar otro cambio al caos. Razonable.
...
#### 16. "Solo atiendo IMSS/ISSSTE" (gobierno)

**Lo que dice:** "Yo puro gobierno" / "Mis pacientes son de seguro, no de particulares"

**Lo que realmente piensa:** Cree que el software es solo para consultorios privados con cobro directo.

**Respuesta:**

"Claro, pero digame: ¿tambien tiene pacientes particulares? Aunque sean poquitos. Porque muchos doctores del IMSS atienden su consultorio particular por las tardes o fines de semana. Ahi es donde DocFacil le sirve: para llevar esos expedientes, agendar esas citas, cobrar esas consultas. Y si nada mas es gobierno puro, le entiendo — probablemente no es para usted ahorita. Pero guarde mi tarjeta por si algun dia abre su privado."

**Pregunta de seguimiento:** "¿Tiene consultorio particular aparte del hospital? ¿Aunque sea unas horas a la semana?"

---

#### 17. "Ya estoy viejo para esto"

**Lo que dice:** "Yo ya soy de la vieja escuela" / "Eso es para los jovenes"

**Lo que realmente piensa:** Miedo a no poder. Orgullo. No quiere sentirse lento o torpe. Es una cuestion emocional, no logica.
...
#### 18. "Mi consultorio es muy pequeno"

**Lo que dice:** "Es un consultorio chico, no necesito sistema" / "Nada mas somos el doc y yo"

**Lo que realmente piensa:** Cree que el software es para clinicas grandes. No se ve como candidato.
...
Usa estos cuando ya veas senales de compra. No vendas — facilita.
...
> "Sabe que, en vez de que yo le explique mas, dejeme ensenarle. ¿Tiene 5 minutos? Le abro el demo aqui en su cel y usted le pica. Hay una clinica de prueba con pacientes falsos para que vea como se siente. Si no le gusta, me dice y ya."

### Cierre 3: El WhatsApp de Seguimiento

> "Le dejo mi WhatsApp. Si le nace la curiosidad esta noche o el fin de semana, me manda mensaje y le mando el link. Cero presion, nomas cuando usted quiera. Eso si, le voy a mandar un videito de 2 minutos para que vea como funciona, ¿va?"
...
- **Audio vs texto:** Los doctores prefieren audios cortos (30-45 seg). Graba audios, no mandes muros de texto.

---

## Tips para Visita en Consultorio

- **Llega con la demo lista en tu celular o tablet.** No pierdas tiempo abriendo cosas.
- **Habla con la secretaria primero.** Ella es la que mas sufre con el papeleo. Si la convences a ella, ella convence al doctor.
- **Lleva algo fisico:** Una tarjeta, un flyer sencillo con QR al demo. Algo que quede en el escritorio.
- **No pidas mas de 5 minutos.** Si te dan 5, haz que valgan. Si el doctor pica, te va a dar mas tiempo solo.
- **Nunca hables mal de la competencia.** Di "es buena opcion, nosotros hacemos X diferente."
- **Si dice no, sal con elegancia.** "Perfecto, doctor, le dejo mi tarjeta. El dia que quiera lo platicamos." Un "no" hoy puede ser un "si" en 3 meses.

---

## Resumen Rapido por Tipo de Objecion

| Tipo | Estrategia central |
|---|---|
