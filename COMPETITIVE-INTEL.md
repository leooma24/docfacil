...
- **Precio:** ~$5,000-$15,000 USD licencia unica + mantenimiento anual (~$3,000 USD/ano)
- **Funciones principales:** Gestion dental completa, odontograma avanzado, radiografias, facturacion de seguros (USA), programacion de citas, imaging, reportes clinicos
- **Target:** Consultorios dentales en Estados Unidos
- **Debilidades vs DocFacil:**
  - No disponible en espanol para Mexico
  - Software on-premise (requiere instalacion local, servidor propio)
  - Precio prohibitivo para consultorios mexicanos
  - Disenado para sistema de seguros de USA (no aplica en Mexico)
  - Sin WhatsApp
  - Sin version web/nube accesible
  - Sin portal de paciente web moderno

### 1.3 SimplyBook.me
- **Tipo:** Plataforma de agendamiento generica (no medica)
- **Precio:** Gratis (limitado) / ~$170 MXN / ~$420 MXN / ~$850 MXN por mes (Basic/Standard/Premium)
- **Funciones principales:** Agenda online, reservas web, recordatorios email/SMS, pagos online, integraciones (Zoom, Google Calendar), widget para sitio web, app movil
- **Target:** Cualquier negocio con citas (salones, consultores, medicos, fitness)
- **Debilidades vs DocFacil:**
  - NO es software medico (sin expediente clinico, sin recetas, sin diagnosticos)
  - Sin odontograma
...
### 1.4 Abysmed
- **Tipo:** Software medico mexicano
- **Precio:** ~$399-$999 MXN/mes (estimado, precios bajo cotizacion)
- **Funciones principales:** Expediente clinico electronico, agenda, recetas, notas medicas, historial clinico, reportes
- **Target:** Consultorios medicos en Mexico
- **Debilidades vs DocFacil:**
  - Interfaz menos moderna
  - Sin odontograma (enfoque medico general, no dental)
  - WhatsApp limitado o sin integracion
  - Sin check-in QR
...
- **Precio:** ~$500-$1,200 MXN/mes segun plan
- **Funciones principales:** Expediente clinico, agenda, recetas electronicas, notas SOAP, historial, firma electronica, reportes basicos
- **Target:** Medicos y especialistas en Mexico
- **Debilidades vs DocFacil:**
  - Interfaz anticuada
  - Sin odontograma
...
### 1.6 Nimbo (nimbo.com.mx)
- **Tipo:** Expediente clinico electronico en la nube
- **Precio:** Gratis (limitado) / ~$599 MXN / ~$999 MXN por mes
- **Funciones principales:** Expediente clinico (NOM-004), agenda, recetas, notas medicas, historial clinico, reportes, firma electronica, plantillas personalizables
...
### 1.7 Medisuite
- **Tipo:** EHR / Software clinico
- **Precio:** Variable, generalmente bajo cotizacion (~$800-$2,000 MXN/mes estimado)
- **Funciones principales:** Expediente clinico, gestion hospitalaria, agenda, facturacion, laboratorios, farmacia, reportes
- **Target:** Clinicas medianas y hospitales (no consultorio individual)
- **Debilidades vs DocFacil:**
  - Sobredimensionado para consultorio individual
  - Precio elevado
  - Sin enfoque dental/odontograma
...
### 1.8 Huli (huli.io)
- **Tipo:** Software medico para Latinoamerica
- **Precio:** ~$29-$79 USD/mes (~$500-$1,400 MXN/mes)
...
- **Precio:** ~$24-$79 USD/mes (~$420-$1,380 MXN/mes) por profesional
- **Funciones principales:** EHR, agenda online, telemedicina, reportes/analytics, CRM de pacientes, integraciones, facturacion, marketing automatizado
- **Target:** Clinicas en Europa y mercados internacionales
- **Debilidades vs DocFacil:**
...
## 4. Vulnerabilidades de DocFacil (Que nos falta)

### 4.1 Criticas (resolver en 3-6 meses)
...
### 4.3 Menores (backlog)
- Sin integracion con Google Calendar bidireccional
- Sin templates de notas SOAP avanzadas
- Sin modulo de inventario/farmacia
- Sin marketing automatizado para reactivar pacientes inactivos
- Sin integracion con aseguradoras mexicanas
...
- "Agenda, expediente, recetas y WhatsApp — todo en uno"
- "De la libreta al sistema, sin quebrar tu bolsillo"

### Angulo de venta por tipo de competidor
