        ...
        <div class="content">
            ...
            <div class="founder">
                ...
                <p style="margin: 10px 0;">
                    <span style="text-decoration: line-through; color: #999;">$299/mes</span>
                    <span style="font-size: 24px; font-weight: bold; color: #0d9488; margin-left: 10px;">${{ number_format($clinic->founder_price ?? 149, 0) }}/mes</span>
                </p>
