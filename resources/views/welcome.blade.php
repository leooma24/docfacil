...
<head>
    ...
    <meta property="og:image" content="{{ asset('images/logo_doc_facil.png') }}">
    ...
    <section class="relative pt-32 pb-24 px-4 overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto text-center relative z-10">
            ...
            <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up delay-300">
                ...
                <a href="{{ url('/doctor/login') }}" onclick="event.preventDefault(); document.getElementById('demo-form').submit();"
                ...
                <form id="demo-form" action="{{ url('/doctor/login') }}" method="POST" class="hidden">
                    @csrf
                    <input type="hidden" name="email" value="demo@docfacil.com">
                    <input type="hidden" name="password" value="demo2026">
                </form>
            </div>
