...
<div x-data="docfacilChatbot()" x-cloak>
    ...
    <button type="button" x-show="!open" @click="toggle()" aria-label="Abrir chat"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" fill="currentColor" aria-hidden="true" style="display:block;margin:0;flex-shrink:0;grid-area:1/1;">
