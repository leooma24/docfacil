<x-filament-widgets::widget>
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 md:gap-3">
        <a href="{{ route('filament.doctor.resources.appointments.create') }}" class="flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-xl no-underline transition" style="background:#f0fdfa;border:1px solid #99f6e4;">
        ...
        <a href="{{ route('filament.doctor.resources.patients.create') }}" class="flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-xl no-underline transition" style="background:#eff6ff;border:1px solid #bfdbfe;">
        ...
        <a href="{{ route('filament.doctor.resources.payments.create') }}" class="flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-xl no-underline transition" style="background:#ecfdf5;border:1px solid #a7f3d0;">
        ...
        <a href="{{ route('filament.doctor.resources.prescriptions.create') }}" class="flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-xl no-underline transition" style="background:#faf5ff;border:1px solid #d8b4fe;">
        ...
        <a href="{{ route('filament.doctor.pages.consultation') }}" class="flex items-center gap-2 md:gap-3 p-3 md:p-4 rounded-xl no-underline transition col-span-2 sm:col-span-1" style="background:#fef3c7;border:1px solid #fcd34d;">
