<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <div class="space-y-2">
            ...
            <div class="flex items-center justify-between gap-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800/40 hover:bg-teal-50 dark:hover:bg-teal-900/20 transition">
                <div class="min-w-0 flex-1">
                    <div class="font-medium text-gray-900 dark:text-gray-100 truncate">{{ $p['name'] }}</div>
                    <div class="text-xs text-gray-500 dark:text-gray-400">
                        @if($p['age']) {{ $p['age'] }} años · @endif
                        {{ $p['phone_display'] }}
                    </div>
                </div>
