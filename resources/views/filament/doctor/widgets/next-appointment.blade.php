        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2 pl-15 sm:pl-0">
                <a href="{{ route('filament.doctor.pages.consultation', ['appointment' => $next->id]) }}"
                    class="inline-flex items-center justify-center gap-2 px-4 py-2.5 md:py-2.5 bg-white text-teal-700 rounded-xl font-bold text-sm no-underline hover:bg-gray-50 transition">
                ...
                <a href="https://wa.me/52{{ preg_replace('/\D/', '', $next->patient->phone) }}" target="_blank"
                    class="inline-flex items-center justify-center gap-2 px-4 py-2.5 md:py-2.5 bg-white/20 text-white rounded-xl font-semibold text-sm no-underline hover:bg-white/30 transition">
