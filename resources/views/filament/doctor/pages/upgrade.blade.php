        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.25rem;">
            ...
            $plans = [
                [
                    ...
                    'features' => ['1 doctor', '200 pacientes', 'Citas ilimitadas', 'WhatsApp', 'Recetas PDF'],
                    'popular' => false,
                ],
                [
                    'name' => 'Profesional',
                    'price' => $founder ? $founderPrice : '299',
                    'original' => $founder ? '299' : null,
                    'features' => ['3 doctores', 'Pacientes ilimitados', 'Recetas PDF', 'Reportes completos', 'Odontograma', 'Consentimientos'],
                    'popular' => true,
                ],
                [
                    'name' => 'Clinica',
                    'price' => $founder ? (string)(intval($founderPrice) > 149 ? $founderPrice : '249') : '499',
                    'original' => $founder ? '499' : null,
                    'features' => ['Doctores ilimitados', 'Multi-sucursal', 'Soporte prioritario', 'Todo incluido'],
                    'popular' => false,
                ],
            ];
            @endphp
