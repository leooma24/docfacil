    ...
    <div style="max-width:900px;margin:0 auto;">
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1.25rem;">
            ...
            $plans = [
                ...
                [
                    'name' => 'Pro',
                    'price' => $founder ? (string)(intval($founderPrice) > 299 ? $founderPrice : '399') : '599',
                    'original' => $founder ? '599' : null,
                    'features' => [
                        'Hasta 3 doctores',
                        'Pacientes ilimitados',
                        '✨ Todo lo del Básico +',
                        '🤖 Dictado inteligente IA (estructura todo)',
                ...
                [
                    'name' => 'Clínica',
                    'price' => $founder ? (string)(intval($founderPrice) > 599 ? $founderPrice : '799') : '1,199',
                    'original' => $founder ? '1,199' : null,
                    'features' => [
                        '🏥 Doctores ilimitados',
                        '🏢 Multi-sucursal',
                        '✨ Todo lo del Pro',
