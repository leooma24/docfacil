<x-filament-panels::page>
    ...
    @else
    {{-- Walk-in: select or create patient using Filament form --}}
    <div style="max-width:560px;margin:0 auto;">
        <div class="bg-white dark:bg-gray-800" style="border:1px solid #e5e7eb;border-radius:1.25rem;padding:2rem;">
            ...
            <div style="margin-top:1.5rem;">
                <button wire:click="startWalkIn" style="width:100%;padding:0.875rem;background:linear-gradient(135deg,#0d9488,#0891b2);color:white;border:none;border-radius:0.75rem;font-weight:700;font-size:0.9rem;cursor:pointer;">
