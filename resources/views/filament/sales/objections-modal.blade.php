    ...
    $objeciones = [
        ['cat' => 'PRECIO', 'items' => [
            ...
            ['q' => '"¿Por qué pagar si puedo usar Excel/libreta?"',
             'a' => 'Puede seguir con Excel, pero Excel no le manda WhatsApp a sus pacientes. Tampoco genera recetas PDF con su cédula ni tiene un expediente pensado para la NOM-004, con notas que se bloquean a las 24 horas. DocFácil hace todo eso por $499/mes y ahorra horas al día.',
        ...
        ['cat' => 'TECNOLOGÍA', 'items' => [
            ...
            ['q' => '"¿Y si se cae el internet?"',
             'a' => 'DocFácil funciona en la nube, así que si se le cae el internet lo que ya guardó no se pierde: queda en el servidor y hay respaldo automático diario. Y hoy en día el internet está en todos lados. Además funciona desde su celular con datos móviles.',
             'follow' => '¿En su consultorio tiene WiFi normalmente?'],
        ]],
        ['cat' => 'CONFIANZA', 'items' => [
            ['q' => '"¿Mis datos están seguros?"',
             'a' => 'Sí. La conexión va cifrada (HTTPS), hay respaldo automático diario y sus datos están separados de los de otras clínicas. Puede activar la verificación en dos pasos, y las notas y recetas se bloquean a las 24 horas. Para los datos de sus pacientes le damos aviso de privacidad y contrato de encargado. Los servidores están en Estados Unidos.',
            ...
            ['q' => '"Necesito pensarlo"',
             'a' => 'Claro doctor, tómese su tiempo. Le activo la prueba gratuita de 15 días para que lo explore con calma. Sin tarjeta, sin compromiso. Si al día 15 no le convence, simplemente no paga nada. ¿Le parece?',
