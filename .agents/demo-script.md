...
## ANTES DE LA DEMO (5 min preparación)

1. **Login a la cuenta demo** en `docfacil.tu-app.co/demo` o directo:
   - Email: `demo@docfacil.com`
   - Password: `demo2026`
2. **Verifica que tienes:**
   - 20 pacientes cargados (Pacientes → ver lista)
   - Citas del día visibles en el dashboard
   - Algunas citas pendientes de confirmar
3. **Cierra otras pestañas** — solo dejar DocFácil visible
4. **Tu WhatsApp Web abierto** en otra pestaña por si demuestras el recordatorio en vivo
5. **Manda al dentista al iniciar:** "Doctor, le voy a compartir pantalla. Si en cualquier momento tiene una pregunta, pare la demo. La idea no es que vea TODO, es que vea las 3 cosas que más le van a servir."

---

## ESTRUCTURA — 10 MINUTOS DIVIDIDOS
...
| 9-10 | Pedir el trial AHORA | Ask para registrarse ya |
...
## MIN 1-3 — HERO #1: RECORDATORIO WHATSAPP 1-CLIC
...
## MIN 3-5 — HERO #2: EXPEDIENTE + ODONTOGRAMA
...
> "¿Cómo lo lleva hoy — papel? ¿Excel? ¿Nada?"

(Aquí va a confesar lo que hace y eso le da más razón al sistema.)

---

## MIN 5-7 — RECETAS PDF + COBROS WHATSAPP
...
## MIN 7-9 — PRECIOS Y OFERTA

### Lo que muestras

Vas a la landing en otra pestaña: `docfacil.tu-app.co/dentistas` → scroll a sección de **Precios**.
...
## MIN 9-10 — CIERRE: PEDIR REGISTRO AHORA

### Lo que muestras

Abres `docfacil.tu-app.co/doctor/register` en otra pestaña.

### Lo que dices

> "Doctor, le voy a hacer la propuesta concreta.
>
...
> "Perfecto. Le mando la liga ahorita por WhatsApp. Mientras la abre, una pregunta para acelerar — ¿tiene su lista de pacientes en Excel, en libreta, o en otro sistema? Para ayudarle a importar."

### Si dice "déjame pensarlo"

→ Usa el playbook → `trust_think`:
> "Por supuesto. Una pregunta antes — ¿qué información específica le falta? Si es algo concreto lo resolvemos hoy. Si necesita coordinarse con su asistente, le mando un resumen de 1 página para esa conversación."

### Si dice "después te marco"

> "Sin pena. Le pongo recordatorio yo mismo y le marco el [día específico, ej viernes]. ¿A qué hora le acomoda más, mañana o tarde?"

(NO permitas "te marco luego" sin fecha — eso es un soft no.)
...
2. **Siempre pregunta antes de presentar.**
   ...
   - Esto te dice qué enfatizar

3. **No menciones features que no usen.**
   - Si es solo dentista (no clínica grande), NO menciones reportes por doctor
   - Si no tiene asistente, NO menciones cuentas múltiples

4. **Habla del precio AL FINAL, no antes.**
   - Si lo pregunta antes, contesta breve: "Entre $499 y $1,999 según plan, pero déjeme primero mostrarle qué hace, vale más con contexto."

5. **Pide el cierre directo.**
   - ❌ "Espero le haya gustado la demo"
...
## SI EL DEMO ES POR WHATSAPP VIDEO (no presencial)

Ajustes:
- **Demo dura 7 min, no 10** — atención cae más rápido en pantalla del cel
- **Salta cobros** si el dentista no preguntó por dinero
- **Comparte pantalla en celular si pueden** — más simple que screenshare
- **Después del demo, manda screenshots** clave por WhatsApp para que tenga referencia

---

## CHECKLIST POST-DEMO (mismo día)

- [ ] Si SÍ se registró: marcar como `interested` en panel ventas + enviarle bienvenida WhatsApp
- [ ] Si dijo "después": agendar follow-up en 48h con notificación
- [ ] Si dijo NO: marcar `lost` con razón en notas
- [ ] Cualquier objeción nueva que dijo: agregar a `.agents/objection-playbook.md`

---

## SCRIPT REDUCIDO (1 página para imprimir)
