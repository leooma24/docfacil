        ...
        return [
            ...
            'como-reducir-inasistencias-consultorio' => [
                ...
                'content' => [
                    ...
                    ['type' => 'cta', 'text' => 'Con DocFácil estos recordatorios quedan listos para mandarlos con un clic desde tu WhatsApp. Pruébalo 15 días gratis.'],
                ],
            ],
            ...
            'software-consultorio-medico-mexico-guia' => [
                ...
                'content' => [
                    ...
                    ['type' => 'cta', 'text' => 'DocFácil cumple con todo esto: 15 días gratis, sin tarjeta, soporte WhatsApp directo, cancela cuando quieras.'],
                ],
            ],
            ...
            'expediente-clinico-digital-nom-004' => [
                ...
                'content' => [
                    ...
                    ['type' => 'p', 'text' => 'Sí. La NOM-004 permite usar medios electrónicos en el expediente (numeral 5.12), en los términos de las demás disposiciones aplicables. Lo que no cambia: cada nota lleva fecha, hora, nombre completo y firma de quien la elabora (5.10), sin enmendaduras ni tachaduras (5.11); el expediente es confidencial y se conserva al menos 5 años desde el último acto médico (5.4). Y como son datos de salud, también te aplica la ley de protección de datos personales.'],
                    ['type' => 'h2', 'text' => 'Ventajas del digital sobre el papel'],
                    ['type' => 'p', 'text' => 'El papel se pierde, se moja, no se puede buscar. Un expediente digital te permite buscar por nombre en segundos, es más difícil de perder (con respaldos automáticos), puede guardar el historial de cambios de cada nota y genera reportes.'],
                    ['type' => 'h2', 'text' => 'Consentimiento informado'],
                    ['type' => 'p', 'text' => 'La norma también pide carta de consentimiento informado en ciertos casos, como cirugía mayor, anestesia general o regional y procedimientos de alto riesgo, con el nombre completo y la firma del paciente (numerales 10.1.1 y 10.1.2); en odontología, la NOM-013 pide además la firma de un testigo. Que el paciente firme con el dedo en una tablet o celular te ahorra papel y deja registradas la fecha y la hora, pero no es una firma electrónica avanzada (e.firma). Si tienes dudas sobre un procedimiento en particular, consúltalo con tu abogado.'],
                    ['type' => 'cta', 'text' => 'DocFácil está pensado para ayudarte con la NOM-004: las notas se bloquean 24 horas después de guardarlas, queda historial de cambios, los diagnósticos usan el catálogo CIE-10 y el paciente firma sus consentimientos en pantalla. Pruébalo gratis 15 días.'],
                ],
            ],

            'recetas-electronicas-mexico-guia-completa' => [
                'title' => 'Recetas electrónicas en México: Guía completa para médicos',
                'description' => 'Lo que dice hoy la regulación sobre recetas electrónicas, qué datos debe llevar la receta y cómo generarlas en segundos.',
                ...
                'content' => [
                    ...
                    ['type' => 'p', 'text' => 'Hoy no hay en México una regla general de receta electrónica. El Reglamento de Insumos para la Salud (artículo 29) pide que la receta lleve impresos el nombre, el domicilio y la cédula profesional de quien prescribe, además de la fecha y la firma autógrafa. El reglamento de la Ley General de Salud en materia de atención médica (artículo 64) acepta firma digital o electrónica "en caso de contar con medios tecnológicos" y pide también el nombre de la institución que expidió tu título. Por eso una receta que solo lleva firma electrónica puede ser rechazada en la farmacia; lo práctico es imprimirla y firmarla a mano. Además debe indicar el medicamento por su nombre genérico, con presentación, dosis, vía de administración, frecuencia y duración del tratamiento.'],
                    ['type' => 'h2', 'text' => 'Excepciones importantes'],
                    ['type' => 'p', 'text' => 'Los medicamentos de la fracción I del artículo 226 de la Ley General de Salud (estupefacientes) no van en receta ordinaria: necesitan el recetario especial de COFEPRIS. En los de la fracción II la farmacia retiene la receta y en los de la fracción III la sella y la registra, así que ahí lo práctico es la receta impresa y firmada a mano. Y desde el 14 de julio de 2026 el tramadol se vende como medicamento controlado: basta una receta ordinaria con tu cédula, y la farmacia la sella y anota la fecha y la cantidad.'],
                    ['type' => 'h2', 'text' => 'Cómo generarlas en segundos'],
                    ['type' => 'p', 'text' => 'Con un software médico como DocFácil, llenas el medicamento, dosis y frecuencia, y el sistema genera un PDF con tu nombre, especialidad, cédula, los datos de tu consultorio, la fecha y una línea para tu firma autógrafa. Lo imprimes y lo firmas, o se lo mandas al paciente por WhatsApp para que lo tenga a la mano.'],
                    ['type' => 'h2', 'text' => 'Ventajas sobre las recetas de papel'],
                    ['type' => 'p', 'text' => '1) Legibles siempre. 2) Tus datos de médico y del consultorio salen impresos en cada receta. 3) Quedan archivadas en el expediente. 4) El paciente no las pierde. 5) Se envían por WhatsApp al instante.'],
